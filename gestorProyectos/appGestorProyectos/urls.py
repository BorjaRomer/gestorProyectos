...
urlpatterns = [
    ...
    path('editar_empleado/<int:pk>/', views.EmpleadoUpdateView.as_view(), name='empleado_edit'),
    path('eliminar_empleado/<int:pk>/', views.EmpleadoDeleteView.as_view(), name='empleado_delete')
]
